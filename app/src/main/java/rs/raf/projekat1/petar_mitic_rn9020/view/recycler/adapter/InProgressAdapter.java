...
public class InProgressAdapter extends ListAdapter<Ticket, InProgressAdapter.ViewHolder> {
    ...
    public InProgressAdapter(@NonNull DiffUtil.ItemCallback<Ticket> diffCallback) {
        super(diffCallback);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Ticket ticket){
            ImageView imageView = itemView.findViewById(R.id.inProgressIv1);
...
//            }
            Glide
                    ...
                    .load( "https://previews.123rf.com/images/eljanstock/eljanstock1811/eljanstock181108567/111612385-.jpg")
                    .into(imageView);
            ((TextView)itemView.findViewById(R.id.progress_title)).setText(ticket.getTitle());
            ((TextView)itemView.findViewById(R.id.progress_description)).setText(ticket.getDescription());
        }
    }
}
